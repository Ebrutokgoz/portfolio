  ...
  return (
    <div className="mt-20">
      <div className="text-center">
        <Image className="w-36 mx-auto mb-2" src={isDarkMode ? assets.logo_dark : assets.logo} alt="logo" />
        <div className="w-max flex items-center gap-2 mx-auto">
          <Image className="w-6" src={isDarkMode ? assets.mail_icon_dark : assets.mail_icon} alt="mail icon" />
